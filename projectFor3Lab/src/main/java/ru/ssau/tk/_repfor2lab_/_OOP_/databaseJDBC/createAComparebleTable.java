...
//                1, user_id, "SqrFunc");
//
//        int function_id1 = m.findMathFunctionsByName("x^2+2x+1_0").getFunctionId().intValue();
//        int function_id2 = m.findMathFunctionsByName("x^2+2x+1_1").getFunctionId().intValue();
//        int function_id3 = m.findMathFunctionsByName("x^2+2x+1_2").getFunctionId().intValue();
//        int function_id4 = m.findMathFunctionsByName("x^2+2x+1_3").getFunctionId().intValue();
//        int function_id5 = m.findMathFunctionsByName("x^2+2x+1_4").getFunctionId().intValue();
//
