...
public class FunctionSelectionDialog {
    ...
    public FunctionSelectionDialog() {
        ...
        grid.setColumns("functionName", "leftBorder", "rightBorder", "amountOfDots");
        grid.getColumnByKey("functionName").setHeader("Имя функции");
        grid.getColumnByKey("leftBorder").setHeader("Левая граница");
        grid.getColumnByKey("rightBorder").setHeader("Правая граница");
