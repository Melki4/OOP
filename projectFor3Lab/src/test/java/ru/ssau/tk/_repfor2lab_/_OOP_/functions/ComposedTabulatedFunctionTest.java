...
class ComposedTabulatedFunctionTest {
    ...
    void getCount() {
        ...
        StrictTabulatedFunction strictArrayFunc2 = new StrictTabulatedFunction(strictArrayFunc);
        assertEquals(3, strictArrayFunc2.getCount(), "Array implementation should have 3 points");
    }
    ...
    void getX() {
        ...
        UnmodifiableTabulatedFunction strictArrayFunc = new UnmodifiableTabulatedFunction(arrayFunc);
        StrictTabulatedFunction strictArrayFunc2 = new StrictTabulatedFunction(strictArrayFunc);
        assertEquals(2.2, strictArrayFunc2.getX(1));
    }
    ...
    void getY() {
        ...
        TabulatedFunction arrayFunc = new ArrayTabulatedFunction(xValues1, yValues1);
        UnmodifiableTabulatedFunction strictArrayFunc2 = new UnmodifiableTabulatedFunction(arrayFunc);
        StrictTabulatedFunction strictArrayFunc = new StrictTabulatedFunction(strictArrayFunc2);
    ...
    void setY() {
        ...
        StrictTabulatedFunction strictArrayFunc2 = new StrictTabulatedFunction(arrayFunc);
        UnmodifiableTabulatedFunction strictArrayFunc = new UnmodifiableTabulatedFunction(strictArrayFunc2);
    ...
    void rightBound() {
        ...
        UnmodifiableTabulatedFunction strictArrayFunc = new UnmodifiableTabulatedFunction(arrayFunc);
        StrictTabulatedFunction strictArrayFunc2 = new StrictTabulatedFunction(strictArrayFunc);
        assertEquals(3.3, strictArrayFunc2.rightBound());
    }
    ...
    void iterator1() {
        ...
        Iterator<Point> iterator = strictArrayFunc2.iterator();
